    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        @if(auth()->user()->role == 1)
          ...
          <li class="nav-item {{ Route::is('admin.sekolah.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.sekolah.*') ? 'fw-bold' : '' }}" href="{{ route('admin.sekolah.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-layer-group"></i></span><span class="nav-link-title">Sekolah</span></a></li>
          <li class="nav-item {{ Route::is('admin.shift.*') ? 'active' : '' }}"><a class="nav-link {{ Route::is('admin.shift.*') ? 'fw-bold' : '' }}" href="{{ route('admin.shift.index') }}" ><span class="nav-link-icon d-md-none d-lg-inline-block"><i class="fa-solid fa-star"></i></span><span class="nav-link-title">Shift</span></a></li>
